...
export default function CardFlowbite() {
  return (
    <>
      ...
      <Default_card />
        <Card_with_CTA_button />
        <Card_with_image />
        <Card_with_custom_image_render_function />
        <Horizontal_card />
        <User_profile_card />
        <Card_with_form />
        <E_commerce_card />
  ...
  return (
    <>
      <div className="border-[1px]">
        <h2 className="text-center text-red-600 font-medium">Default_card</h2>
...
function Card_with_custom_image_render_function() {
  return (
    <>
      <div className="border-[1px]">
        <h2 className="text-center text-red-600 font-medium">
        ...
        <Card
          ...
          renderImage={() => (
            <Image
              width={500}
              height={500}
              src="https://flowbite-react.com/_next/image?url=%2Fimages%2Fblog%2Fimage-1.jpg&w=1080&q=75"
              alt="image 1"
            />
          )}
        >
  ...
  return (
    <>
      <div className="border-[1px]">
        ...
        <Card
          className="max-w-sm"
          imgSrc="https://flowbite-react.com/images/blog/image-4.jpg"
          horizontal
        >
          <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
            Noteworthy technology acquisitions 2021
...
function Card_with_form() {
  return (
    <div className="border-[1px]">
      <h2 className="text-center text-red-600 font-medium">Card_with_form</h2>
      <Card className="max-w-sm">
...
function E_commerce_card() {
  return (
    <div className="border-[1px]">
      <h2 className="text-center text-red-600 font-medium">E_commerce_card</h2>
      <Card
        className="max-w-sm"
...
function CTA_card() {
  return (
    <div className="border-[1px]">
      <h2 className="text-center text-red-600 font-medium">CTA_card</h2>
      <Card className="max-w-sm">
...
function Pricing_card() {
  return (
    <div className="border-[1px]">
      <h2 className="text-center text-red-600 font-medium">Pricing_card</h2>
      <Card className="max-w-sm">
...
function Crypto_card() {
  return (
    <div className="border-[1px]">
      <h2 className="text-center text-red-600 font-medium">Crypto_card</h2>
      <Card className="max-w-sm">
